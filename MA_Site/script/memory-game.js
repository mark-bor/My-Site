...
/*document.querySelectorAll('#front_button').forEach(button => {

	const block_game = document.querySelector('#block_game');
	
	button.onclick = function game () {
		if (block_game.className === 'block_game'){
			block_game.className = 'block_game_2'
		}
	}
});*/
