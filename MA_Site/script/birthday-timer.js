...
var func = setInterval(function () {
    ...
    document.querySelector(".one").style.strokeDashoffset = 394 - ((394/12)*mounts);
    if (mounts < 10){
    ...
    document.querySelector(".two").style.strokeDashoffset = 394 - ((394/31)*days);
    if (days < 10){
    ...
    document.querySelector(".three").style.strokeDashoffset = 394 - ((394/24)*hours);
    if (hours < 10){
    ...
    document.querySelector(".four").style.strokeDashoffset = 394 - ((394/60)*minutes);
    if (minutes < 10){
    ...
    document.querySelector(".five").style.strokeDashoffset = 394 - ((394/60)*seconds);
    if (seconds < 10){
